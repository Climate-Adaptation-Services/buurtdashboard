...
export const DEFAULT_CSV_DATA_URL =
  "https://buurtdashboard-data.s3.eu-north-1.amazonaws.com/buurtdashboard-KEA/csvdata/jan26Buurtdashboarddata.csv.gz";

export const DEFAULT_DATA_DOWNLOAD_URL =
  "https://buurtdashboard-data.s3.eu-north-1.amazonaws.com/buurtdashboard-KEA/data-download/Downloadbuurtdashboard_jan26.xlsx";
