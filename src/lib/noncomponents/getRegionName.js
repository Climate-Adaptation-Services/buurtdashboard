...
? t('Nederland')
: (regio === 'Gemeente')
  ? t("Gemeente") + ' ' + get(allMunicipalitiesJSONData).features.filter(municipality => municipality.properties['GM_CODE'] === get(municipalitySelection))[0].properties[get(municipalityNameAbbreviation)]
  : (regio === 'Buurt')
